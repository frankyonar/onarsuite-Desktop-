...
Versione 0.9.31 del guscio operativo AI-first di OnarSuite. La chat con Max è il punto di ingresso: Max può rispondere, leggere file autorizzati, aprire OnarSuite nel dock autenticato, mostrare output o raccogliere e confermare dati con form dinamici nel Magic Panel.
