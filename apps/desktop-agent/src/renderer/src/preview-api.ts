...
const snapshot: AppSnapshot = {
  appVersion: '0.9.51', connection: 'connected', serverUrl: 'https://onarsuite.com', deviceId: 'dev_preview',
...
export function createPreviewApi(): MaxDesktopApi {
  ...
  return {
    ...
    setMemoryPrivacy: async () => undefined,
