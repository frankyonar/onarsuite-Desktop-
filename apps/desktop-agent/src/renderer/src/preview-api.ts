...
const snapshot: AppSnapshot = {
  appVersion: '0.9.20', connection: 'connected', serverUrl: 'https://onarsuite.com', deviceId: 'dev_preview',
...
export function createPreviewApi(): MaxDesktopApi {
  ...
  return {
    ...
    webSessionUrl: async () => 'https://onarsuite.com/desktop/web-login?token=preview',
